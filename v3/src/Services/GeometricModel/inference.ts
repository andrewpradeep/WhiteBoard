...
export const formatInferenceProgress = (progress: InferenceProgress) => {
...
let loadedGenerator: Text2TextGenerationPipeline | null = null;

export const isModelLoaded = () => loadedGenerator !== null;

export const isModelLoadPending = () => generatorPromise !== null && loadedGenerator === null;
